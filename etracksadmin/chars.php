<html>
<head>
<title>Elastictracks Administration - Characters</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<SCRIPT  ID=clientEventHandlersJS LANGUAGE=javascript><!--     

function button1_onclick() {
   window.location = "addchar.php"
}

function button2_onclick() {
   if (tselect.selectedIndex == -1)
       alert("You must first select a character from the list")
   else
       window.location = "editchar.php?id=" + tselect.options[tselect.selectedIndex].value      
}
...
function button3_onclick() {
   ...
   {
      if (confirm("Delete CharID: " + tselect.options[tselect.selectedIndex].value + "?"))
         window.location = "delchar.php?id=" + tselect.options[tselect.selectedIndex].value
   }
}
...
function button5_onclick() {
   if (tselect.selectedIndex == -1)
       ...
       window.location = "charimage.php?id=" + tselect.options[tselect.selectedIndex].value      
}
...
<INPUT id=button5 name=button5 type=button value="Set Image" LANGUAGE=javascript onclick="return button5_onclick()">&nbsp&nbsp
